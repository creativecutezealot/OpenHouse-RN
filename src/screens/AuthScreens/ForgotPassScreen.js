...
class ForgotPassScreen extends Component {
    ...
    componentDidUpdate(prevProps, prevState){
        if(this.state.loadingtxt !== this.props.login.loadingtxt){
            this.setState({loadingtxt:this.props.login.loadingtxt});
        }
        if(this.state.spinner === false && this.props.login.resetpasswordstatus === 100 ){
            this.setState({spinner: true});
        }
        if(this.state.spinner === true && prevProps.login.resetpasswordstatus === 100 && this.props.login.resetpasswordstatus >= 200 ){
