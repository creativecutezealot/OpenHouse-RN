...
class CreateAccountScreen extends Component {
    ...
    componentDidUpdate(prevProps, prevState){
        ...
        if(this.state.spinner === false && this.props.createaccount.realtortitlesstatus === 100 ){
            this.setState({spinner: true});
        }
        if(this.props.createaccount.realtortitlesstatus >= 200 && this.state.spinner === true && prevProps.createaccount.realtortitlesstatus === 100){
    ...
    gonext=()=>{
        ...
        if(!firstname || firstname.length < 2){
            ...
            this.props.addnewaccountinfo(data);
        }
