            ...
            >
                ...
                <View style={styles.formviewcontainer}>
                    <View style={styles.imgcontainer1}>
                        <Text style={{fontSize: 19,}}>Are You Currently Working Exclusively</Text>
                    </View>
                    <View style={styles.imgcontainer1}>
                    <Text style={{fontSize: 19,}}>With A Licensed Real Estate Agent</Text>
                    </View>
...
export default connect(mapStateToProps, mapDispatchToProps)(BuyerActivity);
