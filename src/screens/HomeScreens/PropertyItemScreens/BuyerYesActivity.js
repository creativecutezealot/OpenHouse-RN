...
class BuyerYesActivity extends Component {
    ...
    continue=()=>{
        ...
        if(!agentfullname || agentfullname.length < 3)   {
            ...
            Alert.alert(
                '',
                'Agent Cellphone is Required',
            );
        }
        else if(!agentofficename || agentofficename.length < 3){
            Alert.alert(
                '',
                'Agent OfficeName is Required',
            );
        }
        else {
            let data ={
            ...
            >
                ...
                <View style={styles.formviewcontainer}>
                    <View style={styles.imgcontainer1}>
                        <Text style={{fontSize: 19,marginTop:5,marginBottom:5,}}>Enter Agent Information</Text>
                    </View>
                    <View style={styles.formitemcontainer}> 
                        <Item stackedLabel style={styles.txtviewitem}>
                            <Label style={styles.txtlabel}>Agent's Full Name</Label>
                            <Input value={this.state.agentfullname} style={styles.txtitem2}
                                onChangeText={(text) => this.setState({agentfullname:text})}
                            />
                        </Item>
                        <Item stackedLabel style={styles.txtviewitem}>
                            <Label style={styles.txtlabel}>Agent's Cellphone or Office Number</Label>
                            <Input value={this.state.agentcellphone} style={styles.txtitem2}
                        ...
                        <Item stackedLabel style={styles.txtviewitem}>
                            ...
                            <Input value={this.state.agentofficename} style={styles.txtitem2}
...
export default connect(mapStateToProps, mapDispatchToProps)(BuyerYesActivity);
