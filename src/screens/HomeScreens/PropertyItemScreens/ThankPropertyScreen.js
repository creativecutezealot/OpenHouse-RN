...
class ThankPropertyScreen extends Component {
    ...
    componentDidMount() {
        let that = this;
            setTimeout(function(){that.setTimePassed()}, 3000);
    }
            ...
            >
                ...
                <View style={styles.formviewcontainer}>
                    <View style={styles.imgcontainer1}>
                        <Text style={{fontSize: 19,marginTop:5,marginBottom:5,}}>Thank You for Registering at</Text>
                    </View>
                    <View style={styles.imgcontainer1}>
                        <Text style={{fontSize: 13,marginTop: 5}}>
                            {this.props.dashboard.selectedproperty.property_address} ,{this.props.dashboard.selectedproperty.property_city},{this.props.dashboard.selectedproperty.property_state},
...
export default connect(mapStateToProps, mapDispatchToProps)(ThankPropertyScreen);
