...
export const initialState = {
    ...
    homedata:[
        {name:"Properties",desc:"Manage your current and expired listings. Add custom properties." ,img:"property"},
        {name:"Events",desc:"Manage your current and past events.Create a new event." ,img:"event"},
        {name:"Lead Management",desc:"Manage, view or export your Open House attendees." ,img:"lead"},
        {name:"Open House Questions",desc:"Enable or disable Open House questions." ,img:"question"},
        {name:"My Board / MLS",desc:"Link your Open Account to your Local Board of Realtors or MLS/IDX Data feed." ,img:"mls"},
        {name:"Mortgage Partners",desc:"Add, managed and view your Mortgage and Real Estate Partners" ,img:"mortgage"},
        {name:"Your Profile",desc:"Update your Profile Information." ,img:"profile"},
        {name:"Request Support",desc:"Contact Open House Marketing System Technical Support Department." ,img:"support"},
    ]
